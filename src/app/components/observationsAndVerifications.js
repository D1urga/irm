...
export default function ObservationsAndVerifications({ onClickFun }) {
  ...
  return (
    <div className={styles.main}>
      <div className={styles.outer_div}>
        ...
        <button
          className={page === 1 ? styles.conc_btn : styles.conc_btn1}
          onClick={() => {
            setPage(1);
          }}
        >
        ...
        <button className={styles.add_attach_button}>Add Attachment</button>
      </div>
      {page === 0 ? (
