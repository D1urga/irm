...
import styles from "./typeareports.module.css";
...
export default function Home() {
  ...
  const handleSubmitRegister = async (event) => {
    ...
    formData.append(
      ...
      JSON.stringify(projectDescriptionData)
    );
    ...
    formData.append(
      ...
      JSON.stringify(projectDescriptionTable)
    );
    formData.append(
    ...
    formData.append(
      "observationsAndVerificationsData",
      JSON.stringify(observationsAndVerificationsData)
    );
    formData.append("assessmentLossNotes", JSON.stringify(assessmentLossNotes));
    formData.append("assessmentLossTable", JSON.stringify(assessmentLossTable));
    formData.append(
